# -*- coding: utf-8 -*-
"""Gemma-2B Attention SAE — Interpretability Score (Original Method)
...
# ================================================================
# 3. Load Gemma-2B & SST-2 Validation
# ================================================================
...
for layer in LAYERS_TO_ANALYZE:
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        f.write(f"GEMMA-2B INTERPRETABILITY REPORT - Layer {layer}, top-{TOP_K} global features\n")
        f.write("=" * 70 + "\n\n")
