# -*- coding: utf-8 -*-
"""DeepSeek Europarl - Interpretability Score Only (MLP SAE, Layers 12 & 18)

Standalone Stage 2 script: skips probing, directly runs Groq interpretability
for the top 2 layers from previous MT results.
...
# ================================================================
# 2. Load Europarl and build val set
# ================================================================
...
# Recreate the same val set (same seed as main script)
random.seed(42)
...
val_texts = [text for text, _ in val_dataset]
...
val_text_ds = TextDataset(val_texts)
...
def llama_interpretation(top_texts, top_acts):
    prompt = (
        "You are analyzing a sparse autoencoder feature from DeepSeek-R1-Distill-Qwen-1.5B on Europarl translation quality detection.\n"
...
# ================================================================
# 6. Pipeline for One Feature (with NaN retry)
# ================================================================
...
for layer in LAYERS_TO_ANALYZE:
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        f.write(f"INTERPRETABILITY REPORT - DeepSeek-R1-Distill-Qwen-1.5B, Layer {layer}, Europarl MT, top-{TOP_K} global features\n")
        f.write("="*70 + "\n\n")
...
print("\nCOMPLETE - DeepSeek Europarl MT Interpretability Analysis")
