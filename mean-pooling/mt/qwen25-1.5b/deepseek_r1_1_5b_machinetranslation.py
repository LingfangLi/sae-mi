# -*- coding: utf-8 -*-
"""DeepSeek-R1-Distill-Qwen-1.5B + SAE (Machine Translation - Europarl)
...
with open(os.path.join(RESULTS_DIR, 'baseline_results_deepseek.txt'), 'w') as f:
    f.write("="*70 + "\n")
    f.write("BASELINE - ZERO-SHOT PROMPTING (DeepSeek-R1-Distill-Qwen-1.5B, Europarl MT)\n")
    f.write("="*70 + "\n\n")
...
# ================================================================
# 5. STEP 2: Layer-wise Analysis (Probes + SAE on MLP outputs)
# ================================================================
print("\n" + "="*70)
...
for layer_num in range(n_layers):
    ...
    with open(os.path.join(RESULTS_DIR, f"layer_{layer_num}_complete_analysis_deepseek.txt"), "w") as f:
        f.write("="*70 + "\n")
        f.write(f"LAYER {layer_num} - COMPLETE ANALYSIS (DeepSeek-R1-Distill-Qwen-1.5B, Europarl MT)\n")
        f.write("="*70 + "\n\n")
...
print(
    ...
    f"{'Equiv Feat':<12} {'Div Feat':<12} {'Common':<10}"
)
print("-"*90)
...
with open(os.path.join(RESULTS_DIR, "final_summary_deepseek.txt"), "w") as f:
    f.write("="*70 + "\n")
    f.write("FINAL SUMMARY - LAYER-WISE ANALYSIS (DeepSeek-R1-Distill-Qwen-1.5B + SAE, Europarl MT)\n")
    f.write("="*70 + "\n\n")
